...
import { getGeometryLayers, saveGeometryLayers } from "../map.api";
import {
  CUSTOM_START_DRAW,
  CUSTOM_CANCEL_DRAW,
  CUSTOM_DRAW_STOPPED,
  ...
  CUSTOM_START_EDIT,
} from "./providers/drawnGeometries";
import type { DrawnGeometry, DrawnLayer, MapOverlayCategory } from "../map.schema";

type Geometry = DrawnGeometry;
type CustomLayer = DrawnLayer;
type LayerCategory = MapOverlayCategory;
