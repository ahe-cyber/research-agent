...
export async function GET() {
  return readJsonFileResponse(overlayPath, { overlays: [] }, "Failed to read overlays.");
}
...
export async function POST(request: Request) {
  ...
  return jsonResponse(overlay, { status: 201 });
}
...
export async function PUT(request: Request) {
  ...
  await writeJsonFile(overlayPath, { overlays: body.overlays });
