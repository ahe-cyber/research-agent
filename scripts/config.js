const STATEN_ISLAND_BOUNDS = [
  [-74.2726, 40.4774],
  [-74.0342, 40.6513]
];

const STATEN_ISLAND_BBOX = [-74.2726, 40.4774, -74.0342, 40.6513];
const STATEN_ISLAND_CENTER = [-74.1502, 40.5795];
const DEV_MODE_STORAGE_KEY = "mapAppDevMode";

function getMapboxAccessToken() {
  return getEnvValue("MAPBOX_ACCESS_TOKEN");
}
